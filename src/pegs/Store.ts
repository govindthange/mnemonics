class Store {
    ...
    propLabels: string[] = ["SAW", "SEED", "SNOWMAN", "SUMO's sculpture", "SIERRA frame", "SOIL", "SEWAGE pipe", "SACK", "SOFA", "SOAP", "TISSUE", "TOAD", "TIN", "DOME", "TYRE", "DOLL", "DISH", "DECK", "TOFFY/TV", "TAP", "NEWS bulletin board ", "NET", "NANNY", "NEEM", "SONAR sensor", "NAIL", "SNOWSHOE", "NUKE", "KNIFE", "NIB", "MAZE", "MAT", "MINE", "MUMMY", "MIRROR/HAMMER", "MAIL", "MATCH", "MUG", "MOVIE", "MOP", "RICE", "ROD", "RAIN", "RAM", "RAR", "RAIL", "RIDGE", "RAKE", "ROOF", "ROPE", "LACE", "LED", "LANE", "LOOM", "LORRY", "LILY", "LEASH", "LOCK", "LEAF", "LAB", "JUICE", "JET", "GENIE", "GEM", "JAR", "JAIL", "JUDGE", "JACK", "CHEF's statue ", "JEEP", "GAS", "KITE", "GUN", "CAM", "CAR", "COIL", "CASH", "CAKE", "CUFF", "CUP", "VACE", "VIDEO disk", "FAN", "FOAM", "FIRE", "FOIL", "FISH", "FOGG deo-spray", "FIFA cup", "VIP pass", "BUS", "BED", "BIN", "PALM tree", "BAR", "BELL", "POUCH", "BIKE", "BUFFET table ", "PIPE"];
    textureLabels: string[] = ["with a SANDY texture", "with a TRANSLUCENT exterior", "covered in NYLON fabric", "with a MOSAIC surface", "with a ROCKY surface", "with a LEATHERY texture", "with a JELLIFIED thin membrane ", "with a GLASSY body", "with a WOODEN texture", "with a PLASTIC body"];
    ...
    conditionLabels: string[] = [" and deep SCRATCHES", " and DAMP surface", " and brand NEW", " but MUDDIED everywhere", " and RUST", " and ELECTROCUTED surface", " and JAGGED sharp corners & edges", " decorated with GLITTERS", " and a very FLAKY surface", " and PUFFING out"];

    roles: string[] = ["SUPERHEROE", "TYCOON", "NATURELOVER", "MOVIESTAR", "ROCKSTAR", "LEGEND", "CHACHA", "CRICKETER", "VILLAIN", "POLITICIAN"];
    roleLabels: string[] = [" POWERFUL ", " rich TYCOON Mr. ", " NATURE lover holding a ", " famous MOVIE star Mr. ", "n international ROCK star ", " LEGENDARY ", " CHACHA dancer ", "n Indian CRICKETER Mr. ", " VILLAIN ", "n international POLITICAL figure Mr. "];
    actors: string[][] = [
        ["SUPERMAN", "THOR", "ANTMAN", "captain MARVEL", "IRONMAN", "HULK", "JAMES bond", "CAPTAIN america", "WONDERWOMAN", "BATMAN"],
        ["SANJAY Leela Bhansali", "DONALD Trump", "NARAYAN Murthi", "MUKESH Ambani", "RATAN Tata", "LAKHANI", "?", "EKTA Kapoor", "VIJAY Mallya", "BILL Gates"],
    ...
    actorAssaultLabels: string[] = ["is shot by a double barrel SHOTGUN", "is attacked by a TROOP", "is attacked by a NINJA", "is shot by a MACHINE Gun", "is shot by a REVOLVER", "falls on a ELECTROCUTED barbedwire", "is attacked by a CHOPPER", "is hit by a GRENADE", "falls victim to a FIGHTER jet attack", "is attacked by a BAZOOKA"];
