class Store {
    ...
    conditionLabels: string[] = ["SCRATCHED", "DAMP", "brand NEW", "MUDDIED", "RUSTED", "n ELECTROCUTED", "JAGGED sharp edged", "GLITTERING", "FLAKY", "PUFFED out"];
