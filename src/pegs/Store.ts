class Store {
    ...
    textureLabels: string[] = ["with a SANDY texture", "with a TRANSLUCENT exterior", "covered in NYLON fabric", "with a MOSAIC look", "with a ROCKY look", "with a LEATHERY texture", "with a JELLIFIED thin membrane ", "with a GLASSY body", "with a WOODEN look", "with a PLASTIC body"];
