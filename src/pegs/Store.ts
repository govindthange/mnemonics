class Store {
    ...
    roleLabels: string[] = [" POWERFUL ", " rich TYCOON Mr. ", " NATURE lover ", " famous MOVIE star Mr. ", "n international ROCK star ", " LEGENDARY ", " CHACHA dancer ", "n Indian CRICKETER Mr. ", " VILLAIN ", "n international POLITICAL figure Mr. "];
    actors: string[][] = [
