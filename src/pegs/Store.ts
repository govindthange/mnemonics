class Store {
    ...
    textureLabels: string[] = ["SANDY textured", "TRANSLUCENT", "NYLON clothed", "MOSAIC styled", "heavy ROCKY surfaced", "LEATHERY", "JAGGED sharp edged", "GLITTER body", "WOODEN styled", "PLASTIC bodied"];
    conditionImages: string[] = ["0-scratched.png", "1-tarred.png", "2-nailed.png", "3-muddied.png", "4-rusted.png", "5-labelled.png", "6-jagged.png", "7-glitter.png", "8-flakes.png", "9-papered.png"];
    conditionLabels: string[] = ["SEALED/SCRATCHED", "DAMP/DENTED", "brand NEW", "MUDDIED", "RUSTED", "n ELECTROCUTED", "JELLY like slimy", "CRACKED", "FLAKY", "PUFFED out"];
