...
const conditionImages: string[] = ["0-scratched.png", "1-tarred.png", "2-nailed.png", "3-muddied.png", "4-rusted.png", "5-labelled.png", "6-jagged.png", "7-greased.png", "8-firedup.png", "9-papered.png"];
const conditionLabels: string[] = [", with a SCRATCHED surface revealing its inside ", ", covered with TAR in ", ", sealed using NAILS in ", ", in a MUDDIED ", ", RUSTED in ", ", LABELLED in ", ", JAGGED to dangerously expose its sharp corners & edges in", ", GREASED in ", ", emitting FLAMES in ", ", all PAPERED in "];
