...
const conditionImages = ["0-smoked.jpg", "1-tarred.jpg", "2-nano-sized.png", "3-muddied.png", "4-rusted.png", "5-labelled.png", "6-chopped.png", "7-greased.png", "8-firedup.png", "9-pores.png"];

// https://www.spycolor.com/color-index,g
const colorCodes = ["#c0c0c0", "#00f5ff", "#000080", "maroon", "red", "#ccff00", "#36454f", "#d4af37", "white", "black"];
