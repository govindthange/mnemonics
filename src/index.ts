...
const conditionLabels: string[] = [", with a SCRATCHED surface revealing its inside ", ", covered with TAR in ", ", sealed using NAILS in ", ", in a MUDDIED ", ", RUSTED in ", ", LABELLED in ", ", CHOPPED to reveal its inside ", ", GREASED in ", ", emitting FLAMES in ", ", all PAPERED in "];
    ...
    return {
        ...
        site: {
            location: {
                ...
                imagePath: "./images/sites/clip-art/" + locationImages[siteLocationIdx]
            },
            weather: {
                n: siteWeatherIdx,
